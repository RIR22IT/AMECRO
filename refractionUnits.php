...
<head>
	...
	<title>Amecro - Refraction Units</title>
		...
		<div class="holder breadcrumbs-wrap mt-0">
			<div class="container">
				<ul class="breadcrumbs">
					...
					<li><span>Refraction Units</span></li>
				</ul>
			</div>
		</div>
		<div class="holder">
				...
				<div class="row collection-grid-2 mobile-sm-pad custom-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2">
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/WCT-100.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>Wheel chair table WCT-100</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
						...
						<h4>Work Table (HD3200)</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD700C.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>Work Table (HD700C)</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD-18T.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-18A instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD-18B.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-18B instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
						...
						<h4>HD-18C Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD-18T.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-18T Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD-20.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-20 Instrument table</h4>
					</div>


					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/instrumentTables/HD-40.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-40 Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/refractionUnits/HD-80.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-80 Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/refractionUnits/HD-120.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-120 Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/refractionUnits/HD-700.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>HD-700 Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/otherType/Hulk-Instrument-Table.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>Hulk- Instrument Table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/medicals/otherType/Titan-Instrument-Table.png" class="lazyload fade-up" alt="Category Name">
						</div>
						<h4>Titan- Instrument table</h4>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
						...
						<h4>Jack Pro-Instrument table</h4>
					</div>
				</div>
			</div>
		</div>
