...
<head>
	...
	<title>Amecro - Plastic Dustbin</title>
		...
		<div class="holder breadcrumbs-wrap mt-0">
			<div class="container">
				<ul class="breadcrumbs">
					...
					<li><span>Plastic Dustbin</span></li>
				</ul>
			</div>
		</div>
		<div class="holder">
				...
				<div class="row collection-grid-2 mobile-sm-pad custom-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2">
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/15847-2014829121844.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/71706-2014829121829.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/23336-2014829121747.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/27657-2014829121721.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/28438-2014829121639.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/92086-2014829121615.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/38864-2014829121555.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/08468-2014829121443.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">DUSTBIN</h3>
					</div>
					...
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/86917.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-1100A</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/83902.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-660A</h3>
					</div>
					...
					<div class="collection-grid-2-item w-100 text-center">
						...
						<h3 class="collection-grid-2-title">LD-360A</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/67958-2014531165232.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-240A-1</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/16506-2014531164443.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-240A-2P1</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/76296-2014627165432.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-240A-3</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/33542-2014531164050.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-240B-1</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/plasticDustbin/75508-2014531163958.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LD-240B-2</h3>
					</div>
