...
<head>
	...
	<title>Amecro - Pet Product</title>
				...
				<div class="row collection-grid-2 mobile-sm-pad custom-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2">
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/57339.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-001S</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/80386.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-001M</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/75491.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-001L</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/53988.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-002MINI</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/40365.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-002S</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/71786.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-002M</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/91420.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-002L</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/85922.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-003</h3>
					</div>


					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/22621.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-004</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/16078.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-005S</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/18680.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-005M</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/15609.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-005L</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/59358.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-0061</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/65523.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-007MINI</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/18520.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-007XS</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/petProduct/31967.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LPP-007S</h3>
					</div>
