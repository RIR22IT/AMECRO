...
<head>
	...
	<title>Amecro - Kids Furnitures</title>
		...
		<div class="holder breadcrumbs-wrap mt-0">
			<div class="container">
				<ul class="breadcrumbs">
					...
					<li><span>Kids Furniture</span></li>
				</ul>
			</div>
		</div>
		<div class="holder">
			<div class="container">
				...
				<div class="row collection-grid-2 mobile-sm-pad custom-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2">
					<div class="collection-grid-2-item w-100 text-center">
						...
						<h3 class="collection-grid-2-title">LKF-501</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/24374-201461104925.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-502</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/51181-201461105245.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-503</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/88466-201461105436.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-504</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/03402-201461105159.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-505</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/68910-201461105339.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-506</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/76394-201461104750.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-507</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/60280-201461104727.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-508</h3>
					</div>


					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/50265-201461104345.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-509</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/48434-201461104410.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-510</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/55429-201461104852.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-511</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/11086-201461104436.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-512</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/15115-201461104830.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-513</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/21731-201461104701.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-514</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/39676-2014610134508.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-515-1</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/kidsFurniture/90353-2014610134303.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LKF-515-2</h3>
					</div>
