...
<head>
	...
	<title>Amecro - Outdoor Furnitures</title>
		...
		<div class="holder breadcrumbs-wrap mt-0">
			<div class="container">
				<ul class="breadcrumbs">
					...
					<li><span>Outdoor Furniture</span></li>
				</ul>
			</div>
		</div>
		<div class="holder">
			<div class="container">
				...
				<div class="row collection-grid-2 mobile-sm-pad custom-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2">
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/09634-2014630180920.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1101</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
						...
						<h3 class="collection-grid-2-title">LF-1102</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/36031-2014611104849.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1201</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/29732-2014611104909.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1202</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/40059-2014611104931.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1203</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/56076-2014611104955.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1204</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/25241-2014611105010.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1205</h3>
					</div>
					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/30880-2014611105046.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1206</h3>
					</div>


					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/31833-2014611105105.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1207</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/19552-2014611105126.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1208</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/88814-2014618153939.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1209</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; padding-top: 40%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/77218-2014611105207_small.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1301</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; ">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/65010-2014611105227_small.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1302</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; ">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/04689-2014611105314_small.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1303</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%; ">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/38870-2014611105335_small.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1304</h3>
					</div>

					<div class="collection-grid-2-item w-100 text-center">
						<div class="collection-grid-2-img image-container" style="padding-bottom:90.0%;">
							<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/plastics/outdoorFurniture/73122-2014611105354_small.jpg" class="lazyload fade-up" alt="Category Name">
						</div>
						<h3 class="collection-grid-2-title">LF-1305</h3>
					</div>

				</div>
			</div>
			<!-- <div class="more-link-wrapper text-center"><a href="category.html" class="btn">All Products</a></div> -->
		</div>
